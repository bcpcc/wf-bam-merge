...
bamstats reads.bam -s test.merged -u         -f bamstats_results/bamstats.flagstat.tsv -t 2         -i bamstats_results/bamstats.runids.tsv         -l bamstats_results/bamstats.basecallers.tsv         --histograms histograms      > /dev/null
